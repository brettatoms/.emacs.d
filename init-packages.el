...
(defun js-mode-hook ()
  ...
  (when (projectile-project-p)
    ;; for flymake-jshint
    (setq jshint-configuration-path (concat (projectile-project-root) ".jshintrc")) 
    ;; for flycheck
    (setq flycheck-jshintrc (concat (projectile-project-root) ".jshintrc"))
    ;; (message (concat "project: " (projectile-project-name)))
    ;; (message (concat "root: " (projectile-project-root)))
